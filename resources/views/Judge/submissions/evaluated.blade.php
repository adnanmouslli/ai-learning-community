...
@section('title', 'المشاركات المقيّمة')
...
<div class="container mx-auto px-4 py-6">
            ...
            <ol class="inline-flex items-center space-x-1 space-x-reverse">
                ...
                <li aria-current="page">
                    <div class="flex items-center">
                        ...
                        <span class="text-sm font-medium text-gray-500">المشاركات المقيّمة</span>
                    </div>
                </li>
            </ol>
        </nav>
    ...
    <div class="flex items-center justify-between mb-6">
        <h1 class="text-2xl font-bold">المشاركات المقيّمة</h1>
    ...
    <div class="bg-white rounded-lg shadow-sm overflow-hidden">
        ...
        <div class="p-4 bg-gray-50 border-b border-gray-200">
            <form action="{{ route('judge.submissions.evaluated') }}" method="GET" class="flex flex-wrap gap-4">
                ...
                <div class="w-full md:w-48">
                    <label for="score" class="block text-sm font-medium text-gray-700 mb-1">النتيجة</label>
                    <select name="score" id="score" class="w-full rounded-md border-gray-300 shadow-sm focus:border-green-500 focus:ring-green-500">
                        <option value="">جميع النتائج</option>
                        <option value="excellent" {{ request('score') == 'excellent' ? 'selected' : '' }}>ممتاز (80-100)</option>
                        <option value="good" {{ request('score') == 'good' ? 'selected' : '' }}>جيد (60-79)</option>
                        <option value="average" {{ request('score') == 'average' ? 'selected' : '' }}>متوسط (40-59)</option>
                        <option value="below_average" {{ request('score') == 'below_average' ? 'selected' : '' }}>ضعيف (0-39)</option>
                    </select>
                </div>
                ...
                <div class="flex items-end">
                    ...
                    <a href="{{ route('judge.submissions.evaluated') }}" class="mr-2 bg-gray-200 py-2 px-4 rounded-lg text-gray-700 text-sm hover:bg-gray-300">
                        إعادة ضبط
                    </a>
                </div>
            </form>
    ...
    @else
        <div class="p-6 text-center">
            ...
            <p class="mt-2 text-gray-500">لم تقم بتقييم أي مشاركات بعد.</p>
        </div>
    @endif
</div>
</div>
